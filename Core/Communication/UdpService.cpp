...
void UdpService::Init(UDPConnectionInfo *connectionInfo)
{
  ...
  /*
  this->macAdress[0] = 0xDE;
  this->macAdress[1] = 0xAD;
  this->macAdress[2] = 0xBE;
  this->macAdress[3] = 0xEF;
  this->macAdress[4] = 0xFE;
  this->macAdress[5] = 0xED;
   */
